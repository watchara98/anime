...
<!-- anime list -->
         <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
           ...
           <li class="breadcrumb-item"><a href="./list.php?id=<?=$id?>">ดูตอนอื่นๆ</a></li>
        ...
        <div class="row">
         ...
         <div class="col-md-12">
            <div class="card box-shadow text-center"><h3>เภสัชกรเทพสองโลก ตอนที่<?=$result['part']?></h3></div>
            <div class="card mb-4 box-shadow">
            <iframe width="100%" height="623" src="https://www.youtube.com/embed/<?=$result['vdo']?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
          </div>
...
<nav aria-label="breadcrumb">
        ...
        <div class="row">
         ...
         <div class="col-md-12">
            <div class="card box-shadow text-center"><h3>Player</h3></div>
            <div class="card mb-4 box-shadow">
            <iframe width="100%" height="623" src="https://www.youtube.com/embed/<?=$result['vdo_main']?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
          </div>
<!-- anime End --> 
<?php }?>         
